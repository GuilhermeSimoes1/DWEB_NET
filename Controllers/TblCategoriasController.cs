...
namespace DWEB_NET.Controllers
{
    public class TblCategoriasController : Controller
    {
        ...
        public TblCategoriasController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CategoriaID,NomeCategoria")] TblCategorias tblCategorias)
        {
            if (id != tblCategorias.CategoriaID)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!TblCategoriasExists(tblCategorias.CategoriaID))
                    {
                        return NotFound();
                    }
                    else
